...
type AdminMatchOption = { id: number; kickoffTime: string; homeTeam: string; awayTeam: string; stage?: string | null; homeScore90?: number | null; awayScore90?: number | null; homeScore?: number | null; awayScore?: number | null; actualPenaltyShootout?: boolean | null; highlightUrl?: string | null };
type OpsPayload = {
...
export default function AdminConsole() {
  ...
  function overrideScore(formData: FormData) {
    ...
    const penaltyValue = String(formData.get("actualPenaltyShootout") ?? "");
    const payload = { homeScore: Number(formData.get("homeScore")), awayScore: Number(formData.get("awayScore")), actual_penalty_shootout: penaltyValue === "" ? null : penaltyValue === "true" };
    setError(null); setMessage(null);
