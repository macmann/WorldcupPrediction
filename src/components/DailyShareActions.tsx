...
export function DailyShareActions({ text, date, path, title = "FFM WC2026 Daily Winner", buttonLabel = "Share my daily score", copiedLabel = "Copied share text" }: DailyShareActionsProps) {
