  ...
  return (
    <div className={`mt-4 ${locked ? "opacity-60" : ""}`}>
      ...
      {locked ? (
        ...
        <button type="button" onClick={savePrediction} disabled={isPending || home === "" || away === ""} className="mt-3 w-full rounded-2xl bg-emerald-600 py-3 font-black text-white shadow-lg shadow-emerald-600/20 transition active:scale-[0.98] disabled:bg-slate-300 disabled:shadow-none">
